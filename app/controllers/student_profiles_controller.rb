class StudentProfilesController < ApplicationController
  ...
  def show
    @skill_catagories = SkillCatagory.order(name: :asc)
  end
  ...
  private
    ...
    def student_profile_params
      params.require(:student_profile).permit(:first_name, :last_name, :phone, :bio, :website, :github_username, :linkedin_url, :photo, :photo, :cv, :city, :country, :user_id)
    end
end
