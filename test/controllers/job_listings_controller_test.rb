...
class JobListingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_listing" do
    assert_difference('JobListing.count') do
      post job_listings_url, params: { job_listing: { company_profile_id: @job_listing.company_profile_id, job_description: @job_listing.job_description, title: @job_listing.title, user_id: @job_listing.user_id } }
    end
  ...
  test "should update job_listing" do
    patch job_listing_url(@job_listing), params: { job_listing: { company_profile_id: @job_listing.company_profile_id, job_description: @job_listing.job_description, title: @job_listing.title, user_id: @job_listing.user_id } }
